...
class shipOrder: public rclcpp::Node
{
    ...
    private:
        rclcpp::Subscription<std_msgs::msg::UInt8>::SharedPtr ship_order_subscriber; /*!< Varaible to hold the ARIAC Order subscription handle*/
        ...
        void agv4_lock_callback(rclcpp::Client<std_srvs::srv::Trigger>::SharedFuture wait_handle);

        void agv3_move_callback(rclcpp::Client<ariac_msgs::srv::MoveAGV>::SharedFuture wait_handle);
        void agv3_lock_callback(rclcpp::Client<std_srvs::srv::Trigger>::SharedFuture wait_handle);

        void agv2_move_callback(rclcpp::Client<ariac_msgs::srv::MoveAGV>::SharedFuture wait_handle);
        void agv2_lock_callback(rclcpp::Client<std_srvs::srv::Trigger>::SharedFuture wait_handle);
        
        void agv1_move_callback(rclcpp::Client<ariac_msgs::srv::MoveAGV>::SharedFuture wait_handle);
        void agv1_lock_callback(rclcpp::Client<std_srvs::srv::Trigger>::SharedFuture wait_handle);

        void start_lock_callback(rclcpp::Client<std_srvs::srv::Trigger>::SharedFuture wait_handle);
        ...
        */
        void shipOrderCallback(const std_msgs::msg::UInt8::SharedPtr msg);
};  